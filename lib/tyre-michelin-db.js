 ...
 * invented Camping CP grid (Michelin UK cites ETRTO 5.5 bar rear
 * guidance, not a size-by-size CP book). CrossClimate Camping CP is
 * handled in tyre-calc: Conti camping row only when size + LI match,
 * plus that 5.5 bar rear floor. No 19.5 / 22.5″ truck sizes. No
 * Goodyear, BFGoodrich or Yokohama. Skip a size if the PDF has only a
 * sidewall max and no inflation steps (e.g. 205/75R16C).
 *
