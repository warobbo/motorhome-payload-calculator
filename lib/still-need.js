/**
 * After a plate lookup (or once the van path is started), show what is
...
(function (root) {
  var LABELS = {
    ...
    limits: "Plate axle limits (front/rear)",
  ...
  function lead() {
    return "A plate lookup is not the finished check. We do not invent these figures.";
  }
  ...
  function dockLine(list) {
    ...
    return "Still need: Mass in Service or empty ticket · plate axle limits · loaded axle weights";
  }
